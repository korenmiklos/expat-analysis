...
\title{Külföldi menedzserek és a magyar vállalatok teljesítménye}

\author{Koren Miklós\\
CEU, MTA KRTK és CEPR\\
Telegdy Álmos\\
MNB és CEU}
...
{Köszönet: ERC Knowledgeflows (313164)\\Fekete Krisztián, Kiss Olivér, Perédi Szilárd,\\ Szilágyi Bálint, Vereckei András, Zágoni Rita, Závecz Gergő}
