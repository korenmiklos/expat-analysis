...
all: output/table/granger.tex output/table/trade.tex output/table/pairwise.tex
...
output/descriptives.log: temp/analysis_sample.dta descriptives.do
	$(STATA) descriptives 
temp/analysis_sample_dyadic.dta: input/fo3-owner-names/country_codes.dta temp/balance-small-clean.dta temp/trade.dta temp/firm_events.dta code/create/analysis_sample.do code/create/event_dummies_firmlevel.do code/create/countries.do
