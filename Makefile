...
all: output/table/selection.tex output/table/diffindiff_main.tex output/table/cross_section_main.tex output/table/exporter.tex
...
output/descriptives.log: temp/analysis_sample.dta descriptives.do
	$(STATA) descriptives 
temp/analysis_sample.dta: input/fo3-owner-names/country_codes.dta temp/balance-small-clean.dta temp/trade.dta temp/firm_events.dta code/create/analysis_sample.do code/create/event_dummies_firmlevel.do
