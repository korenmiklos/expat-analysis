...
cap log close
log using "`here'/output/est_attgt_weights", text replace
...
esttab m* using "`here'/output/table_attgt_weights.tex", mtitle b(3) se(3) replace
esttab m* using "`here'/output/table_attgt_weights.txt", mtitle b(3) se(3) replace
