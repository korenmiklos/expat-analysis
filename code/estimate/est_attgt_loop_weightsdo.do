...
cap log close
log using "`here'/output/est_attgt_loop_weightsdo", text replace
...
esttab m* using "`here'/output/table_attgt_loop_weightsdo.tex", mtitle b(3) se(3) replace
esttab m* using "`here'/output/table_attgt_loop_weightsdo.txt", mtitle b(3) se(3) replace
