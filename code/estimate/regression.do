...
esttab est1 est2  using "output/table/selection_reg.tex", star(* 0.10 ** 0.05 *** 0.01) b(3) scalar("mean2 Mean dep.var.") noconstant nonote se replace label r2 nolegend nonote
