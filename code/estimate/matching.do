...
*Propensity score
gen treat_1=(time_foreign==-1 & ever_foreign==1)
...
egen exactmatch=group(year teaor_aggr)
...
foreach j of local gr  {
	psmatch2 treat_1 if exactmatch == `j', n(3) pscore(propscore) com 
	*cal(0.1)
...
save "$here/temp/analysis_sample_match", replace
