...
esttab model* using "`here'/output/table_attgt_loop_att.tex", mtitle b(3) se(3) replace
esttab model* using "`here'/output/table_attgt_loop_att.txt", mtitle b(3) se(3) replace
