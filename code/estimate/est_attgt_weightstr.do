...
cap log close
log using "`here'/output/est_attgt_weightstr", text replace
...
esttab m* using "`here'/output/table_attgt_weightstr.tex", mtitle b(3) se(3) replace
esttab m* using "`here'/output/table_attgt_weightstr.txt", mtitle b(3) se(3) replace
