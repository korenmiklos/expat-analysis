...
cap log close
log using "`here'/output/est_attgt_ipw_99", text replace
...
esttab m* using "`here'/output/table_attgt_ipw_99.tex", mtitle b(3) se(3) replace
esttab m* using "`here'/output/table_attgt_ipw_99.txt", mtitle b(3) se(3) replace
