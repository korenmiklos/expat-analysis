...
foreach var in has_expat_ceo foreign foreign_hire {
	...
	*attgt exporter lnQL if inrange(year, 1992, 2004) & ever_foreign, treatment(`var') aggregate(e) pre(2) post(3) reps(20)
	attgt lnQ lnQL TFP_cd lnK lnL lnKL exporter if ever_foreign, treatment(`var') aggregate(e) pre(4) post(4) reps(20)
