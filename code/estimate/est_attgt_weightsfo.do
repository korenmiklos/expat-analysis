...
cap log close
log using "`here'/output/est_attgt_weightsfo", text replace
...
esttab m* using "`here'/output/table_attgt_weightsfo.tex", mtitle b(3) se(3) replace
esttab m* using "`here'/output/table_attgt_weightsfo.txt", mtitle b(3) se(3) replace
